...
peer lifecycle chaincode approveformyorg --package-id $CCID --channelID productchannel --name products --version 1 --sequence $2 --waitForEvent --tls --cafile $ORDERER_CA
peer lifecycle chaincode checkcommitreadiness --channelID productchannel --name products --version 1  --sequence $2 --tls --cafile $ORDERER_CA
...
peer lifecycle chaincode commit -o orderer.product.com:7050 --channelID productchannel --name products --version 1 --sequence $2 --tls true --cafile $ORDERER_CA --peerAddresses peer0.city1.product.com:7051 --peerAddresses peer0.city2.product.com:9051 --peerAddresses peer0.city3.product.com:11051  --tlsRootCertFiles ./crypto/peerOrganizations/city1.product.com/peers/peer0.city1.product.com/tls/ca.crt --tlsRootCertFiles ./crypto/peerOrganizations/city2.product.com/peers/peer0.city2.product.com/tls/ca.crt --tlsRootCertFiles ./crypto/peerOrganizations/city3.product.com/peers/peer0.city3.product.com/tls/ca.crt 
